...
import { LoremIcon, SparklesIcon, CopyIcon } from '../common/Icons';
      ...
      {generatedText && (
        <div className={styles.resultBox}>
          <div className={styles.resultHeader}>
            <span className={styles.resultTitle}>Generated Text</span>
            <button onClick={copyToClipboard} className={styles.copyBtn}>
              <CopyIcon /> Copy
            </button>
          </div>
          <textarea className={styles.textarea} value={generatedText} readOnly rows={15} />
        </div>
      )}
    </ToolWrapper>
  );
