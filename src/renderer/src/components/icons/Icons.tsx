...
export const FolderIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path
      d="M1.5 3C1.5 2.72386 1.72386 2.5 2 2.5H6L7.5 4H13.5C13.7761 4 14 4.22386 14 4.5V12.5C14 12.7761 13.7761 13 13.5 13H2C1.72386 13 1.5 12.7761 1.5 12.5V3Z"
      stroke={color}
      strokeWidth="1.2"
      fill="none"
    />
...
export const GitBranchIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    ...
    <path
      d="M4 4.5V11.5M4 5C4 5 6 5 8 7C10 9 10.5 8 10.5 8"
      stroke={color}
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
export const BugIcon: React.FC<IconProps> = ({ size = 16, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path
      d="M8 3C6.5 3 5.5 4 5.5 5.5V8.5C5.5 10 6.5 11 8 11C9.5 11 10.5 10 10.5 8.5V5.5C10.5 4 9.5 3 8 3Z"
      stroke={color}
      strokeWidth="1.2"
      fill="none"
    />
    <path
      d="M5.5 6H2M10.5 6H14M5.5 9H2M10.5 9H14M6.5 3L5 1.5M9.5 3L11 1.5M6 11L4.5 13M10 11L11.5 13"
      stroke={color}
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
export const ToolsIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path
      d="M6 2L4 4L7 7L5 9L2 6L4 4M10 14L12 12L9 9L11 7L14 10L12 12"
      stroke={color}
      strokeWidth="1.2"
      strokeLinecap="round"
...
export const RobotIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    ...
    <path
      d="M8 5V2.5M8 2.5C8 2.5 7 2.5 7 1.5M8 2.5C8 2.5 9 2.5 9 1.5"
      stroke={color}
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
export const RefreshIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path
      d="M2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8C14 11.3137 11.3137 14 8 14C6 14 4.5 13 3.5 11.5M3.5 11.5V14M3.5 11.5H6"
      stroke={color}
      strokeWidth="1.2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const TrashIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path
      d="M3 4H13M5 4V3C5 2.44772 5.44772 2 6 2H10C10.5523 2 11 2.44772 11 3V4M6 7V11M10 7V11M4 4L4.5 13C4.5 13.5523 4.94772 14 5.5 14H10.5C11.0523 14 11.5 13.5523 11.5 13L12 4"
      stroke={color}
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
export const NetworkIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <circle cx="8" cy="8" r="6" stroke={color} strokeWidth="1.2" fill="none" />
    <path
      d="M8 2C8 2 10 5 10 8C10 11 8 14 8 14M8 2C8 2 6 5 6 8C6 11 8 14 8 14M2 8H14M3.5 5H12.5M3.5 11H12.5"
      stroke={color}
      strokeWidth="1.2"
    />
  </svg>
...
export const ChartIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path
      d="M2 13V9M6 13V6M10 13V3M14 13V7"
      stroke={color}
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const ShieldIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path
      d="M8 2L3 4V7C3 10.5 5 13 8 14C11 13 13 10.5 13 7V4L8 2Z"
      stroke={color}
      strokeWidth="1.2"
      strokeLinejoin="round"
      fill="none"
...
export const ExternalLinkIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    <path
      d="M12 8.5V12C12 12.5523 11.5523 13 11 13H4C3.44772 13 3 12.5523 3 12V5C3 4.44772 3.44772 4 4 4H7.5"
      stroke={color}
      strokeWidth="1.2"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M7 9L13 3" stroke={color} strokeWidth="1.2" strokeLinecap="round" />
  </svg>
);
...
export const LiveIcon: React.FC<IconProps> = ({ size = 16, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className}>
    ...
    <circle cx="8" cy="8" r="5" stroke={color} strokeWidth="1.2" fill="none" opacity="0.5" />
    <circle cx="8" cy="8" r="7" stroke={color} strokeWidth="1" fill="none" opacity="0.25" />
  </svg>
);
